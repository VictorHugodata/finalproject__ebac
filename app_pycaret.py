...
def main():
    ...
    if data_file_1 is not None:
        ...
        if model_choice == "LightGBM (PyCaret)":
            model_saved = load_model('/Users/Victor Hugo/Desktop/projetofinal/model_final')  # Arquivo do LightGBM
        ...
        # Se a escolha for Regressão Logística, use o pipeline do sklearn
            ...
            pipeline = joblib.load('/Users/Victor Hugo/Desktop/projetofinal/model_regressao_logistica.pkl')
